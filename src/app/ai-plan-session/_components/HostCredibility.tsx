      ...
      >
        ...
        <div>
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-ink-soft sm:text-[16px]">
            {"I'm Nazir, and I built Traq Collective on doing AI work inside businesses myself rather than handing it off. I brief each decision, then move trio to trio while you write. The timer moves the room on, not me. That's the real reason it's capped at fifteen: past that, I can't get to every trio inside the minutes each decision has."}
          </p>
          <Link
            href="/about"
